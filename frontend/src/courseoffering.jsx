...
export default function CourseOffering() {
    ...
    async function createOffering() {
        ...
        // ✅ IMPORTANT: Always use mongoUserId (backend expects ObjectId)
        const educatorId = localStorage.getItem("mongoUserId") || null;

        if (!educatorId) {
            alert("No educator account found. Please log in again.");
            return;
        }
