        ...
        <>
            ...
            <div className="container">
                ...
                <div className="card" onClick={() => openCard("info")}>
                    <h2>Information</h2>
                    <p>
                        The Freelance Tutoring Platform is a web-based academic support system designed to connect students with qualified tutors and professors through a secure, user-friendly digital environment.
                        ...
                        Security and reliability are central to the system design, with secure authentication mechanisms, encrypted communication, and structured database schemas to ensure data integrity and user privacy.
                    </p>
                </div>
